...
set "KEY_VALUE_DB=todos-db"
set "KEY_VALUE_USER=todos-user"
set "KEY_VALUE_PASSWORD=todos-password"

set "LOCALHOST_PORT=27017"
set "CONTAINER_PORT=27017"

set "NETWORK_NAME=todos-network"

set "VOLUME_NAME=todos-mongo-data"
...
docker run --name %CONTAINER_NAME% --rm ^
    ...
    -v "%CD%/db-config/mongo-init.js:/docker-entrypoint-initdb.d/mongo-init.js" ^
